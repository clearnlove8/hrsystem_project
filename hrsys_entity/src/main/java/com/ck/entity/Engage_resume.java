...
public class Engage_resume {
    ...
    private Engage_interview engage_interview;//面试一对一关系

    public Engage_interview getEngage_interview() {
        return engage_interview;
    }

    public void setEngage_interview(Engage_interview engage_interview) {
        this.engage_interview = engage_interview;
    }
